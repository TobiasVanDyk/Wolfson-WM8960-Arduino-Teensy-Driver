...
*Note 6: Infineon released a 16bit/24bit/32bit and 44.1kHz/48kHz [**driver for the WM8960**](https://github.com/Infineon/audio-codec-wm8960) about two years ago (1991). This driver was recently [**adapted by pschatzmann**](https://github.com/pschatzmann/arduino-wm8960) for Arduino to use the Wire API. Refer to the [**Infineon-Arduino-wm8960**](/Infineon-Arduino-wm8960) section.*
