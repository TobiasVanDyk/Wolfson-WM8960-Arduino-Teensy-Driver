...
Subjectively, listening to the same source material through headphone output on the waveshare wm8960 hat dac, matches the experience when using the same headphones with a Creative AE-5 (which has a dedicated headphone amp), setup.
