...
Proto-driver (eventually as a library), and example applications for Arduino and Teensy MCUs using the Wolfson WM8960 Audio DAC, with a seperate BTL 1W speaker and headphone amplifier (common grounded). (It should be possible to use the BTL speaker outputs through 100uF capacitors with a common groound headphone as well.)
