...
*Note 6: Infineon released a [**driver for the WM8960**](https://github.com/Infineon/audio-codec-wm8960) about two years ago. This driver was [**adapted by pschatzmann**](https://github.com/pschatzmann/arduino-wm8960) for Arduino to use the Wire API. Refer to the [**Infineon-Arduino-wm8960**](/Infineon-Arduino-wm8960) section.*
