...
*Note 7: Cirrus Logic has indicated that they will [**stop manufacturing the WM8960 during 2024**](https://www.cirrus.com/products/eol/). The [**WM8962B**](https://master-nq.webp2.cirrus.com/products/wm8962b/) is recommended as a replacement. Note  that is also an old design the [**linux ALSA driver**](https://github.com/torvalds/linux/blob/master/sound/soc/codecs/wm8962.c) is dated 2010*
